...
from app.schema.ocr.callback import CALLBACKInput
from app.schema.ocr.callback import CALLBACKOutput
...
Input, Output = mlaas_item_generator('CALLBACK', CALLBACKInput, CALLBACKOutput)
