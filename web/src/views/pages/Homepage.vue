    ...
    <header id="header" class="fixed-top header-scrolled">
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto active" @click="smoothScroll('#hero')" v-ripple>首頁</a></li>
                    <li><a class="nav-link scrollto" @click="smoothScroll('#about')">關於產品</a></li>
                    <li><a class="nav-link scrollto" @click="smoothScroll('#services')" v-ripple>核心功能</a></li>
                    <!-- <li><a class="nav-link   scrollto" href="#portfolio">Portfolio</a></li> -->
                    <li><a class="nav-link scrollto" @click="smoothScroll('#team')" v-ripple>開發團隊</a></li>
                    <li><a class="nav-link scrollto" @click="smoothScroll('#faq')" v-ripple>常見問題</a></li>
            ...
            <ul>
              ...
              <li><a href="#">Drop Down 4</a></li>
                    ...
                    <li><a class="nav-link scrollto" @click="smoothScroll('#contact')" v-ripple>聯繫我們</a></li>
                    <li><router-link to="/auth/login" class="getstarted scrollto">立即體驗</router-link></li>
                </ul>
            ...
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="d-flex justify-content-center justify-content-lg-start">
                        <router-link to="/auth/login" class="btn-get-started scrollto">立即體驗</router-link>
                    </div>
                </div>
    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content">
                    <div class="col-lg-6">
                        <p>這是一款致力於解決行內通用光學字元辨識的問題。</p>
                        <ul>
                            <li><i class="ri-check-double-line"></i> PDF</li>
                            <li><i class="ri-check-double-line"></i> 身份證</li>
                            <li><i class="ri-check-double-line"></i> 健保卡</li>
                        </ul>
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        <p>本服務將可以為您的日常工作帶來相當大的便利，讓您可以一鍵解決影像辨識難題。</p>
            ...
            <div class="container-fluid" data-aos="fade-up">
                <div class="row">
                    <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch order-2 order-lg-1">
                        <div class="content">
                            <h3>來自<strong>ＯＯ處特別推薦</strong></h3>
                            <p>太便利了，加速我的工作效率！</p>
                        </div>
                        ...
                        <div class="accordion-list">
                            <ul>
                                <li>
                                    <a data-bs-toggle="collapse" class="collapse" data-bs-target="#accordion-list-1"><span>01</span> 操作困難嗎? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                                    <div id="accordion-list-1" class="collapse show" data-bs-parent=".accordion-list">
                                        <p>完全不會，一目了然！沒用過這麼好用的系統！</p>
                                    </div>
                                </li>

                                <li>
                                    <a data-bs-toggle="collapse" data-bs-target="#accordion-list-2" class="collapsed"><span>02</span> 辨識度準嗎? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                                ...
                                <li>
                                    <a data-bs-toggle="collapse" data-bs-target="#accordion-list-3" class="collapsed"><span>03</span> 此服務免費嗎? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch order-lg-2" data-aos="fade-right" data-aos-delay="100">
            ...
            <div class="container" data-aos="fade-up">
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
                        <h3></h3>
                        <p class="fst-italic">這是我們比較其他產品的辨識準確度...</p>

                        <div class="skills-content">
                            <div class="progress">
                                <span class="skill">本產品 <i class="val">99.97%</i></span>
                                <div class="progress-bar-wrap">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="99.97" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>

                            <div class="progress">
                                <span class="skill">A 廠牌 <i class="val">90%</i></span>
                                <div class="progress-bar-wrap">
                            ...
                            <div class="progress">
                                <span class="skill">B 廠牌 <i class="val">75%</i></span>
                                <div class="progress-bar-wrap">
                            ...
                            <div class="progress">
                                <span class="skill">C 廠牌 <i class="val">55%</i></span>
                                <div class="progress-bar-wrap">
        ...
        <section id="team" class="team section-bg">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2>開發團隊</h2>
                    <p>本服務由不同的團隊分工合作，由 CV、Finbrain、科技賦能 共同研發完成。</p>
                </div>
