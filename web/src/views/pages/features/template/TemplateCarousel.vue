...
import img4_1 from '@/assets/img/template_step/step4-1.png';
import img4_2 from '@/assets/img/template_step/step4-2.png';
...
export default {
  ...
  setup(props) {
    ...
    const contentList = reactive([
        ...
        <img src="${img5}" height="200" />
        <p>確認標註, 確認無誤即可送出新增模板。</p>
        ` },
    ]);
    return {
        contentList,
