            ...
            <div class="card" style="height: 80vh; overflow-y: scroll">
                ...
                <div class="flex flex-column">
                    <div class="flex align-items-center justify-content-center h-4rem font-bold border-round m-2">
                        ...
                        <SelectButton v-model="selectedRectangleType" :options="rectangleTypes" optionLabel="name" @change="handleLook(template_id, selectedRectangleType?.code)" class="selectButton" aria-labelledby="custom"/>
                    </div>
